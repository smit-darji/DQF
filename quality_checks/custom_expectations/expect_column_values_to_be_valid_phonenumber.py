...
def is_valid_phonenumber(phone_number) -> bool:
    ...
    try:
        z = phonenumbers.parse(phone_number, 'US')
...
# For most ColumnMapExpectations, the main business logic for calculation
# will live in this class.
...
class ExpectColumnValuesToBeValidPhonenumber(ColumnMapExpectation):
    ...
    # This is a list of parameter names that can affect whether the
    # Expectation evaluates to True or False
    success_keys = ("mostly",)

    # This dictionary contains default values for any parameters that
    ...
    def validate_configuration(
        ...
        sets a configuration if it has yet to be set. Ensures that
        necessary configuration arguments have been provided for the
        validation of the expectation.
        Args:
            configuration (OPTIONAL[ExpectationConfiguration]): \
                An optional Expectation Configuration entry that will be
                used to configure the expectation
        Returns:
        ...
        # # Check other things in configuration.kwargs and raise Exceptions
        # if needed
        # try:
        #     assert (
        #         ...
