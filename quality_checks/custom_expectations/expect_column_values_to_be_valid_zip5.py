...
# For most ColumnMapExpectations, the main business logic for calculation will
#  live in this class.
class ColumnValuesToBeValidZip5(ColumnMapMetricProvider):
    ...
    # This method defines the business logic for evaluating your
    #  metric when using a SqlAlchemyExecutionEngine
...
class ExpectColumnValuesToBeValidZip5(ColumnMapExpectation):
    ...
    library_metadata = {
        ...
        "contributors": [  # Github for all contributors to this Expectation.
            "@luismdiaz01",
